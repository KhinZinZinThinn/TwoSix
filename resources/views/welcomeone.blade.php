        ...
        <div class="row">
            ...
            <div class="col-md-4 mt-2 d-none d-sm-block" >
                ...
                <div id="carouselExampleIndicators" class="carousel slide mb-3" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="{{URL::to('images/four.jpg')}}" alt="First slide">
                            <div class="carousel-caption">
                                <h5>Hello World</h5>
                                <p> Welcome to our Shopping </p>
                                <a href="{{route('products')}}" class="btn btn-outline-success btn-lg">Go to Product Page</a>
                        ...
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{URL::to('images/one.jpg')}}" alt="Second slide">
                            <div class="carousel-caption">
                                <h5>Hello World</h5>
                                <p>Welcome to our Shopping </p>
                                <a href="{{route('products')}}" class="btn btn-outline-success btn-lg">Go to Product Page</a>
            ...
            <div class="col-md-4 mt-2" >
                ...
                <div id="carouselExampleIndicators" class="carousel slide mb-3" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{URL::to('images/three.png')}}" alt="Second slide">
                            <div class="carousel-caption">
                                <h5>Hello World</h5>
                                <p>Welcome to our Shopping </p>
                                <a href="{{route('products')}}" class="btn btn-outline-success btn-lg">Go to Product Page</a>
                        ...
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{URL::to('images/one.jpg')}}" alt="Third slide">
                            <div class="carousel-caption">
                                <h5>Hello World</h5>
                                <p>Welcome to our Shopping </p>
                                <a href="{{route('products')}}" class="btn btn-outline-success btn-lg">Go to Product Page</a>
